...
- **个人日常可落地**：补真实来源/引用、修订与回收站、自动备份/恢复、结构化与混合搜索、稳定增量布局，并完成 10k 数据门禁。
